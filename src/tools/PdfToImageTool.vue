    ...
    <div class="bg-white rounded-2xl sm:rounded-3xl p-3.5 sm:p-7 shadow-xl border border-slate-100 flex flex-col flex-1">
      ...
      <div class="flex flex-wrap items-center justify-between gap-2.5 pb-2.5 sm:pb-3 border-b border-slate-100 shrink-0">
        <div class="flex items-center space-x-3 min-w-0">
          <div class="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-cyan-50 text-cyan-600 flex items-center justify-center font-bold shrink-0 shadow-2xs">
          ...
          <div class="min-w-0">
            ...
            <div v-if="docBytes && !isZipping && !lastExportedFile" class="flex items-center space-x-2 mt-0.5 min-w-0">
        ...
        <div v-if="docBytes && !isZipping && !lastExportedFile" class="flex items-center space-x-1.5 sm:space-x-2 shrink-0">
      ...
      >
        <div class="w-14 h-14 sm:w-16 sm:h-16 bg-cyan-100/60 text-cyan-600 rounded-2xl sm:rounded-3xl flex items-center justify-center mb-3 sm:mb-4 shadow-sm">
          <ImageDown class="w-7 h-7 sm:w-8 sm:h-8" />
        </div>
      ...
      <div v-else :class="['flex-1 flex flex-col justify-between min-h-0', isZipping || lastExportedFile ? 'pt-4' : 'pt-2.5 sm:pt-3']">
        ...
        <div class="pt-2.5 sm:pt-3 border-t border-slate-100 flex flex-wrap items-center justify-between gap-3 shrink-0">
