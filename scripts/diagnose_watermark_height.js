...
async function testFixes() {
  ...
  for (const vp of viewports) {
    ...
    await page.goto('http://localhost:5173/watermark-pdf', { waitUntil: 'networkidle2' });
    ...
    await page.evaluate(() => {
      ...
      if (card) {
        ...
        // Let's test keeping p-5 sm:p-7 OR p-4 sm:p-6
    ...
    console.log(`[${vp.name}]: Overflow = ${after.hasScrollbar ? '❌ +' + after.overflow + 'px' : '✅ 0px (PERFECT NO SCROLL)'}`);
  }
