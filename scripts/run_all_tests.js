...
const testSuites = [
  { id: 'unit', name: 'Vitest Unit Test Suite (36 files, 230 tests)', cmd: isWindows ? 'npx.cmd' : 'npx', args: ['vitest', 'run'] },
  ...
  { id: 'sanitize', name: 'E2E Business: PDF Sanitize (敏感指纹/XMP流/元数据清理)', cmd: 'node', args: ['scripts/e2e_sanitize_test.js'] },
  { id: 'redact', name: 'E2E Business: PDF Redact (敏感信息脱敏/框选烧录/规则批处理)', cmd: 'node', args: ['scripts/e2e_redact_test.js'] },
